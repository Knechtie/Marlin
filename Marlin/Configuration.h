...
#define PID_K1 0.95      // Smoothing factor within the PID
  ...
  //P22.12 I2.93 D41.68; 19.03.18 @210
  #define  DEFAULT_Kp 22.12
  #define  DEFAULT_Ki 2.93
  #define  DEFAULT_Kd 41.68
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define  DEFAULT_bedKp 375.21
  #define  DEFAULT_bedKi 68.36
  #define  DEFAULT_bedKd 540.84
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 79.21, 400, 100.13 }
...
#define Z_PROBE_SPEED_FAST (HOMING_FEEDRATE_Z * 2)  //HOMING_FEEDRATE_Z
...
//#define Z_HOMING_HEIGHT 8 //4  // (in mm) Minimal z height before homing (G28) for Z clearance above the bed, clamps, ...
